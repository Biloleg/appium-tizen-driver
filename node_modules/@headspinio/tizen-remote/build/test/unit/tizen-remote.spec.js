...
describe('TizenRemote', function () {
    ...
    beforeEach(function () {
        ...
        MockWebSocket = (_a = class MockWebSocket extends node_events_1.EventEmitter {
                /**
                 * @param {string} url
                ...
                constructor(url, opts) {
                    ...
                    this.url = url;
                    this.opts = opts;
                    this.readyState = _a.CONNECTING;
                    this.close = sandbox.stub().callsFake(() => {
                        // this happens synchronously
                        this.readyState = _a.CLOSING;
                        setTimeout(() => {
                            this.readyState = _a.CLOSED;
                    ...
                    this.send = sandbox.stub().callsFake((msg, done) => {
                        setTimeout(() => {
                            ...
                            setTimeout(() => {
                                this.emit(WsEvent.MESSAGE, JSON.stringify({ event: constants.TOKEN_EVENT, data: { token: 'server-token' } }));
                            });
                        });
                    });
                    this.init();
        ...
        ({ TizenRemote, WsEvent, Event, constants } = node_1.default.proxy(() => require('../../lib/tizen-remote'), (r) => ({
            '@humanwhocodes/env': {
            ...
            '@appium/strongbox': r
                ...
                if (prop === 'strongbox') {
                    MockStrongbox.strongbox = /** @type {typeof MockStrongbox.strongbox} */ (sandbox.stub().callsFake(() => {
                    ...
                    describe('when token persistence is enabled', function () {
                        ...
                        describe('when token cache get is a miss', function () {
                            ...
                            it('should attempt to retrieve the token from the device', async function () {
                                await expect(() => remote.connect(), 'to emit from', remote, Event.TOKEN, 'server-token');
                            });
...
//# sourceMappingURL=tizen-remote.spec.js.map