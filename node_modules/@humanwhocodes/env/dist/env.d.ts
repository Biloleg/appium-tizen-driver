...
export class Env {
     ...
     */
    get<S = undefined>(key: string, defaultValue?: S): S extends string ? S : string | S;
    /**
     ...
     */
    first<S_1 = undefined>(keys: string[], defaultValue?: S_1): S_1 extends string ? S_1 : string | S_1;
    /**
